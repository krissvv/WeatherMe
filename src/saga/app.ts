...
function* onLoadCurrentLocationForecast() {
   ...
   try {
      ...
      //          appid: "f502d0b63dd8f3e2bb462e1a579323af",
      //       },
      //    }),
      // );
      ...
      yield* put(
         appSlice.actions.setCurrentLocationName(currentLocationWeather.data.name),
      );
      yield* put(
         appSlice.actions.setCurrentLocationForecast([
            {
      ...
      yield* put(appSlice.actions.setCurrentLocationName(undefined));
      yield* put(appSlice.actions.setCurrentLocationForecast(undefined));
   }
}
